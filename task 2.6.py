...
d = 0
# пустой список, чтобы не потерять числа для следующей операции
y = []
# числа, которые будут вводиться по одному
a = 0
# сумма квадратов чисел. Будем сюда записывать
g = 0
...
while True:
    ...
    d += a
    y.append(a)
    # Когда сумма чисел равна 0, стопим цикл
    if d == 0:
        break
# Цикл, чтобы посчитать квадраты чисел
for k in y:
    g += k ** 2
print(g)
